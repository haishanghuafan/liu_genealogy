    ...
    <main className="min-h-screen bg-paper">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            {isLoggedIn ? (
              <Link href="/dashboard" className="bg-vermillion text-white px-8 py-4 rounded-lg hover:bg-vermillion-dark transition-colors font-medium flex items-center justify-center gap-2">
                🏠 进入我的家族
              </Link>
            ) : (
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="text-center mt-16">
            {isLoggedIn ? (
              <Link href="/dashboard" className="bg-vermillion text-white px-10 py-4 rounded-lg hover:bg-vermillion-dark transition-colors font-medium text-lg inline-flex items-center gap-2">
                🏠 进入我的家族
              </Link>
            ) : (
      ...
      <section className="py-20">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          {isLoggedIn ? (
            <Link href="/dashboard" className="bg-vermillion text-white px-8 py-4 rounded-lg hover:bg-vermillion-dark transition-colors font-medium text-lg inline-flex items-center gap-2">
              🌟 进入我的家族
            </Link>
          ) : (
